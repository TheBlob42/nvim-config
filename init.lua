...
require('lazy').setup {
...

    {
        ...
        init = function()
            ...
            vim.keymap.set('n', '<leader>gg', function()
                ...
                require('lazygit').lazygit(vim.loop.cwd())
    ...
    -- LSP
    'williamboman/mason.nvim',              -- install external dependencies (LSP servers, DAP servers, etc.)
    ...
    'mfussenegger/nvim-jdtls',              -- special configuration for Java
